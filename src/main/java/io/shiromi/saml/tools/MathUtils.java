...
public interface MathUtils {
    ...
    static boolean equals(NumberType a, NumberType b) {
    ...
    static double constrain(double value, double start, double end) {
    ...
    interface Caster {
        static byte asByte(@NotNull Number n) {
            return new NumberType(n.doubleValue()).byteValue();
        }

        static short asShort(@NotNull Number n) {
            return new NumberType(n.doubleValue()).shortValue();
        }

        static int asInt(@NotNull Number n) {
            return new NumberType(n.doubleValue()).intValue();
        }

        static long asLong(@NotNull Number n) {
            return new NumberType(n.doubleValue()).longValue();
        }

        static float asFloat(@NotNull Number n) {
            return new NumberType(n.doubleValue()).floatValue();
        }

        @Deprecated
        static double asDouble(@NotNull Number n) {
            return new NumberType(n.doubleValue()).doubleValue();
        }
    }
}
