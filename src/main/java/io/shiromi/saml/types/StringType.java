...
public final class StringType extends AbstractType<String> implements Iterable<Character> {
    ...
    /**
     * Creates a new instance of a <code>StringType</code> with a copy of given {@link StringType}'s value
     *
     * @param value the <code>StringType</code> to copy the value of
     * @see #StringType()
     * @see #StringType(char[])
     * @see #StringType(char)
     ...
     * @see #StringType(AbstractType)
     * @since 2.0-11923-J
     */
    public StringType(@NotNull StringType value) {
        this(value.value);
    }
    ...
    /**
     * Creates a new instance of a <code>StringType</code> by using the built-in function {@link Object#toString()}, so make sure it's defined by
     * the class or object you pass in as an argument to avoid the output string being <code>[ClassName]@[hashCode]</code>, e.g.
     * <blockquote><pre>
     * {@code StringType s = new StringType(new File("path/to/file"));}
     * </pre></blockquote>
     *
     * @param o the object to parse to a <code>String</code>
     * @see #StringType()
     * @see #StringType(char[])
     * @see #StringType(String)
     * @see #StringType(StringBuilder)
    ...
    /**
     * Creates a new instance of a <code>StringType</code> by using the function {@link AbstractType#getValue()} to retrieve the
     * value of the given object, e.g.
     * <blockquote><pre>
     ...
     * @since 2.1-22524-J
     */
    public StringType(@NotNull AbstractType<?> type) {
        this(type instanceof NumberType t ? t.doubleValue() : type.value);
    }
    ...
    /**
     * Replaces all lowercase letters in this string with uppercase letters
     *
     * @return a string with all letters being uppercase
     * @see #toLowerCase()
     * @since 1.8-12623-J
     */
    @Contract(" -> new")
    ...
    /**
     * Replaces all uppercase letters in this string with lowercase letters
     *
     * @return a string with all letters being lowercase
     * @see #toUpperCase()
     * @since 1.8-12623-J
     */
    @Contract(" -> new")
    ...
    /**
     * Checks whether this object contains any of the specified characters
     *
     * @param chars the {@code chars} to look for
     * @return {@code true} if this object contains any of the characters
     * @see #contains(String)
     * @since 1.8-12623-J
     */
    @Contract(pure = true)
    public boolean contains(char @NotNull ... chars) {
        for (char c : chars) if (contains(c)) return true;
        return false;
    }

    /**
     * Checks if this object contains only digits as characters
     *
     * @return whether this object contains only digits as characters
     * @since 1.8-12623-J
     */
    public boolean isDigits() {
        for (char c : chars) if (c < 0x30 || c > 0x39) return false;
        return true;
    }
    ...
    public boolean append(@NotNull AbstractType<?> a) {
    ...
    /**
     * Returns the character at the first index
     *
     * @return the character at the first index
     * @see #charAt(int)
     * @since 2.0-22524-J
     */
    public char first() {
    ...
    /**
     * Returns this object's value trimmed to a given length in a {@code char[]}
     *
     * @param start the start index, inclusive
     * @param end   the end index, exclusive
     * @return this object's value trimmed to a given length in a {@code char[]}
     * @see #toCharArray()
     * @see #toArray()
     * @see #toArray(int, int)
     */
    public char[] toCharArray(int start, int end) {
        return substring(start, end).toCharArray();
    }
    ...
    public String @NotNull [] toArray(int start, int end) {
        String[] strings = new String[end - start];
        for (int i = start; i < strings.length; i++) strings[i] = String.valueOf(chars[i]);
        return strings;
    }
     ...
     *
     * @param first the first element to add to the array, <strong>required</strong>
     * @param more  an array of <code>Strings</code> to parse into <code>StringTypes</code>, <em>optional</em>
     * @return an array of <code>StringType</code> containing each corresponding <code>String</code>
     * @see #fromArray(String[], String)
     */
    public static StringType @NotNull [] array(String first, String @Nullable ... more) {
        if (more == null) return new StringType[]{new StringType(first)};
        StringType[] s = new StringType[more.length + 1];

        s[0] = new StringType(first);
        for (int i = 1; i < more.length; i++) {
            s[i] = new StringType(more[i - 1]);
        }
    ...
    public static StringType @NotNull [] array(String @NotNull [] array) {
        String[] t = new String[array.length - 1];
        System.arraycopy(array, 1, t, 0, t.length);
     ...
     *  // results in "A few numbers: 5.0, -15, 25.40000"
     * }</pre></blockquote>
     *
    ...
    /**
     * Replaces a character at the specified index with the given new character
     *
     * @param position the index of the character to replace
     * @param newValue the character to replace with
     * @return this object with the character at the given index replaced
     * @since 2.1-30424-J
     */
    public StringType replaceAt(int position, char newValue) {
        Objects.checkIndex(position, length);
        return replace(position, newValue);
    }

    /**
     * Replaces all occurrences of the given character with the specified new character
     *
     * @param oldValue the value to replace
     * @param newValue the value to replace with
     * @return this object with the first occurrence of the specified character replaced
    ...
    /**
     * Replaces all occurrences of the given <code>String</code> with the specified new <code>String</code>
     *
     * @param oldValue the value to replace
     * @param newValue the value to replace with
     * @return this object with the first occurrence of the specified <code>String</code> replaced
     ...
     * @since 2.0-73123-J
     */
    public StringType replaceAll(String oldValue, String newValue) {
        while (indexOf(oldValue) != -1) replace(oldValue, newValue);
        return this;
    }
