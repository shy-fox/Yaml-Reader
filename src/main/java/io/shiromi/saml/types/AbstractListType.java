...
abstract class AbstractListType<E> extends AbstractType<E[]> implements List<E>, Iterable<E> {
    ...
    public AbstractListType(@Range(from = 0, to = MathUtils.INT_MAX) int initialCapacity) {
        ...
        if (initialCapacity > 0) elementData = new Object[initialCapacity];
                    ...
                    initialCapacity);
        size = initialCapacity == 0 ? DEFAULT_CAPACITY : initialCapacity;
    }
    ...
    @SafeVarargs
    public final boolean addAll(E @NotNull ... elements) {
    ...
    /**
     * Do not use, return's only {@code null}, use {@link #toArray()}, {@link #toArray(Object[]) toArray(T[])} or {@link #toArray(IntFunction)}
     * @return {@code null}
     * @deprecated
     */
    @SuppressWarnings("unchecked")
