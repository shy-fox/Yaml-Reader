...
public final class GenericType extends AbstractType<Object> {
    ...
    public @NotNull BooleanType booleanType() throws CastException {
        if (validBoolean()) return new BooleanType(castValue());
    ...
    private static Class<?> safeAssign(@Nullable Object value) {
        ...
        else if (classOf.getSuperclass() == AbstractType.class) return ((AbstractType<?>)value).classOfT;
        return Object.class;
    }

    private static @Nullable Class<? extends Number> safeAssignNumber(@NotNull Object v) {
    ...
    private static @Nullable Class<?> safeAssignString(@NotNull Object v) {
        ...
        if (v instanceof char[]) return char[].class;
        if (v instanceof String) return String.class;
        if (v instanceof StringBuilder) return StringBuilder.class;
        return null;
    }
}
