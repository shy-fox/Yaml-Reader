...
---
### Version 1.5-public 
[(Release)](https://github.com/shy-fox/Yaml-Reader/releases/tag/v1.5-public)
...
---
### [Version 1.6.1](https://github.com/shy-fox/Yaml-Reader/commit/dc44e7dcb0e92c3ecad435336f90ddb42a7477fe)
[(Release)](https://github.com/shy-fox/Yaml-Reader/releases/tag/v1.6-a.pre)
> Changed some stuff inside `fromString(String)` inside `Yaml` and updated `absoluteSize()` inside `YamlObject`

[< Back to top](#overview)

---
### [Version 1.6.2](https://github.com/shy-fox/Yaml-Reader/commit/7214d07b3d8901a60c77f2dbf3a11792aadd7a61)
[(Release)](https://github.com/shy-fox/Yaml-Reader/releases/tag/v-1.6-b)
...
---
### [Version 1.7](https://github.com/shy-fox/Yaml-Reader/commit/f3d81ba10ef1217c93e5f2bf52c27bdd150e1d2b)
[(Release)](https://github.com/shy-fox/Yaml-Reader/releases/tag/V1.7)
...
---
### Version 1.8 (SAML)
> Rewrote entire library and restructured it

The new structure is as follows:
<pre><code>&boxvr;&boxh; final class SAML
&boxvr;&boxh; elements
&boxv;   &boxur;&boxh; AbstractYamlElement
&boxvr;&boxh; types
&boxv;   &boxvr;&boxh; abstract class AbstractType
&boxv;   &boxvr;&boxh; final class BooleanType
&boxv;   &boxvr;&boxh; final class GenericType
&boxv;   &boxvr;&boxh; final class NullType
&boxv;   &boxvr;&boxh; final class NumberType
&boxv;   &boxur;&boxh; final class StringType
&boxvr;&boxh; tools
&boxv;   &boxvr;&boxh; final class Matcher
&boxv;   &boxur;&boxh; interface MathUtils
&boxvr;&boxh; functions
&boxv;   &boxur;&boxh; interface StringIterator
&boxur;&boxh; exceptions
    &boxvr;&boxh; class CastException
    &boxur;&boxh; class RangeException
</code></pre>
